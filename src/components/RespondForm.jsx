...
function SubmitButton({ disabled }) {
    ...
    return (
        <button
            ...
            className="w-full md:w-[251px] h-[48px] md:h-[56px] lg:h-[81px] rounded-[8px] bg-gradient-to-r from-[#F5AB40]/90 to-[#F5AB40] flex items-center justify-center cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed px-4 md:px-6 lg:px-8 flex-shrink-0"
        >
...
export default function RespondForm() {
    ...
    return (
        <form
            action={action}
                        className="relative flex w-full flex-col gap-3 md:inline-flex md:w-auto md:flex-row md:items-center md:gap-4 lg:gap-[23px]"
        >

                     <div className="flex w-full flex-col md:w-[606px]">
                            <div className={`w-full h-[48px] md:h-[56px] lg:h-[81px] bg-[rgba(231,231,231,0.2)] border rounded-[8px] flex items-center px-3 md:px-4 lg:px-[24px] gap-2 md:gap-3 lg:gap-[16px] ${emailError ? "border-red-500" : "border-[rgba(0,0,0,0.29)]"}`}>
                                <Image
                                    ...
                                    width={24}
                                    height={24}
                                    className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 opacity-60 flex-shrink-0"
                                />
